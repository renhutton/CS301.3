...
#use a wider radius when near the top of the screen - title buttons are smaller
    ...
    if cmd == "MOVE" and len(parts) == 3:
        ...
        if SNAP_ENABLED:
            ...
            if snap:
                ...
                x, y = sx, sy
        mouse.move((x * 1.2) - 400, (y * 1.2) - 200) #add offset
